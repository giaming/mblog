<template>
  <div class="card">
    <p style="margin-top: 0px;color:red;font-size:20px;">网站公告</p>
    <el-divider></el-divider>
    <p style="margin-top: 0px;font-size: 28px;">Welcome to Giaming's Blog</p>
    <!-- <div>
...
export default {
  ...
  methods: {
    ...
    getRunTime() {
      var birthDay = this.NewDate("2022-01-01");
      var today = new Date();
