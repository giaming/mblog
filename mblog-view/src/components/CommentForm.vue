  ...
  methods: {
    ...
    onInputBlur() {
      ...
      if (!isNaN(Number(qq)) && qq.length > 4 && qq.length < 12) {
        ...
        this.commentForm.avatar = "http://r7eb8ajdr.hd-bkt.clouddn.com/avatar/avatar" + randomNum + ".webp"
      ...
      this.$refs.formRef.validate((valid) => {
        if (valid) {
          ...
          if (this.commentForm.isAdminComment == 1) {
            this.commentForm.avatar = "http://r7eb8ajdr.hd-bkt.clouddn.com/avatar/avatar9.webp"
          }
          const _this = this
